                    ...
                    <div class="catalog__nav">
                        <div class="catalog__select-wrap">
                            <select class="catalog__select" name="genres">
                                <option value="all_genres">Tất cả thể loại</option>
                            ...
                            <select class="catalog__select" name="years">
                                <option value="all_years">Tất cả năm</option>
                        ...
                        <div class="slider-radio">
                            ...
                            <input type="radio" name="grade" id="popular"><label for="popular">Phổ biến</label>
                            <input type="radio" name="grade" id="newest"><label for="newest">Mới nhất</label>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-xl-4 order-md-2 order-xl-1">
                    <div class="plan">
                        ...
                        <ul class="plan__list">
                            <li class="green"><svg width="19" height="14" viewBox="0 0 19 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="red"><svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
