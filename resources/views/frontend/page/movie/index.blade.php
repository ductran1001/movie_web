...
@section('content')
    <section class="section section--head section--head-fixed section--gradient section--details-bg">
        <div class="section__bg" data-bg="https://flixtv.volkovdesign.com/main/img/details.jpg"></div>
        <div class="container">
            <!-- article -->
            <div class="article">
                <div class="row">
                                ...
                                <div class="section__series owl-carousel" id="series">
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="https://flixtv.volkovdesign.com/main/img/series/1.jpg" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div class="series">
                                        <a href="details.html" class="series__cover">
                                            <img src="https://flixtv.volkovdesign.com/main/img/series/2.jpg" alt="">
                                            <span>
                                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="section__title"><a href="category.html">Phim liên quan</a></h2>
                </div>

                <div class="col-12">
                    <div class="section__carousel-wrap">
                        <div class="section__carousel owl-carousel owl-loaded" id="similar">
                            <div class="owl-stage-outer owl-height" style="height: 362.953px;">
                                <div class="owl-stage"
                                    style="transform: translate3d(-1329px, 0px, 0px); transition: all 0s ease 0s; width: 5320px;">
                                    @foreach ($relatedMovies as $relatedMovie)
                                        <div class="owl-item cloned" style="width: 191.663px; margin-right: 30px;">
                                            <div class="card">
                                                <a href="details.html" class="card__cover">
                                                    <img src="{{ $relatedMovie['thumbnail'] }}" alt="">
                                                ...
                                                <ul class="card__list">
                                                    <li>
                                                        {{ $relatedMovie->genre->title ?? '[N/A]' }}
                                                    </li>
                                                    <li>
                                                        {{ $relatedMovie->country->title ?? '[N/A]' }}
                                                    </li>
                                                    <li>2018</li>
                                                </ul>
                                            </div>
